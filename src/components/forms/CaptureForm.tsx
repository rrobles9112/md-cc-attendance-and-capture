...
import {
  PRIVACY_NOTICE_ES,
  RETREAT_PRIVACY_NOTICE_ES,
  SENSITIVE_DATA_NOTICE_ES,
} from "@/lib/consent/privacy-notice";
import {
  logGeneralConsent,
  logSensitiveConsent,
} from "@/lib/audit/consent-logger";
...
export function CaptureForm({
  ...
  useEffect(() => {
    ...
    if (initialValues.birthday !== undefined)
      handleBirthdayChange(initialValues.birthday);
    if (initialValues.legalRepName !== undefined)
      setLegalRepName(initialValues.legalRepName);
    if (initialValues.hasWhatsapp !== undefined)
      setHasWhatsapp(initialValues.hasWhatsapp);
    if (initialValues.hasMedicalConditions !== undefined)
      setHasMedicalConditions(initialValues.hasMedicalConditions);
    if (initialValues.medicalConditions !== undefined)
      setMedicalConditions(initialValues.medicalConditions);
    if (initialValues.medicalMedications !== undefined)
      setMedicalMedications(initialValues.medicalMedications);
    if (initialValues.medicalDosage !== undefined)
      setMedicalDosage(initialValues.medicalDosage);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const payload: CaptureSubmitPayload = {
        ...
        medicalMedications: hasMedicalConditions
      ...
      if (hasDuplicate) {
        toast.warning(
          "Se detectó un posible duplicado. El administrador revisará el registro.",
        );
      }
        ...
        <CardContent className="space-y-4">
          ...
          {isMinor && (
            <div className="space-y-2">
              ...
              />
              {errors.legalRep && (
                <p className="text-xs text-destructive">{errors.legalRep}</p>
              )}
      ...
      {copy.showWhatsappCard && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Información de WhatsApp (opcional)
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="hasWhatsapp">
                El número principal tiene WhatsApp
              </Label>
            </div>
            <div className="space-y-2">
              <Label htmlFor="additionalWhatsapp">
                Número adicional de WhatsApp
              </Label>
              <Input
      ...
      {copy.showMedicalCard && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Información de salud (opcional y voluntaria)
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-2">
            ...
            {hasMedicalConditions && (
              <>
                <div className="space-y-2">
                  ...
                  />
                  {errors.medical && (
                    <p className="text-xs text-destructive">{errors.medical}</p>
                  )}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="medicalMedications">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Perfiles en redes sociales (opcional)
                </CardDescription>
              </div>
              <Button
                type="button"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-start space-x-2">
            ...
            />
            <Label
              htmlFor="generalConsent"
              className="font-medium leading-tight"
            >
              He leído y acepto el aviso de privacidad y autorizo el tratamiento
