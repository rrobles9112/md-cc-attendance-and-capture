...
-- Amendment A1 extension (2026-08-29): distinct dollar-quote tags ($do$ outer,
-- $$ inner) — identical tags made the parser close the DO body at the cron
-- command's opening $$ (SQLSTATE 42601), a latent defect the CLI skip bug hid.
